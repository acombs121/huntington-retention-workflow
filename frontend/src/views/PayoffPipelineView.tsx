          ...
          <div className="border-t border-slate-200 dark:border-slate-800 p-6 sm:p-8 space-y-8 animate-fadeIn bg-[#FAFBFD] dark:bg-slate-900/60">
            ...
            <div className="bg-slate-950 text-slate-200 rounded-2xl p-5 font-mono text-xs overflow-x-auto max-h-96 border border-slate-800 shadow-inner space-y-2">
              ...
              <div className="leading-relaxed space-y-1.5 pt-1 text-[11.5px]">
                ...
                <div><span className="text-slate-500">[03:41:34.102]</span> <span className="font-bold text-[#E5736A]">[COMPLIANCE_GATE]</span> NPI handling standard (voluntary control): Elena Vance (15% non-guarantor) programmatically quarantined from profiling.</div>
                <div><span className="text-slate-500">[03:41:36.450]</span> <span className="font-bold text-[#7ECF1C]">[ENRICHMENT_AGENT]</span> Synthesizing Executive 1-Pager: Net equity proceeds sized at $2,902,700 after the $5,214,800 title payoff quote and $382,500 in estimated closing costs.</div>
                ...
                <div className="pl-6 text-slate-400">&bull; Match 1: Sarah Jenkins (Score: 98% &bull; Book: 68 of 95 relationships &bull; Headroom: 27 &bull; Specialty: CRE Liquidity)</div>
                <div><span className="text-slate-500">[03:41:44.204]</span> <span className="font-bold text-[#A7F3D0]">[ROUTING_AGENT]</span> Capacity verification: Sarah Jenkins manages 68 relationships; within the 95–100 capacity threshold under 2x CSA leverage.</div>

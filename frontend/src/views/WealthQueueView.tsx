      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
        ...
        {isUnlocked ? (
          <div className="p-8 sm:p-10">
            <div className="p-6 sm:p-8 rounded-2xl border border-[#A7F3D0] dark:border-emerald-800/60 bg-[#E8F5E9]/30 dark:bg-emerald-950/20 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full text-sm font-bold tracking-wide bg-[#006738] hover:bg-[#1B5630] text-white shadow-sm transition active:scale-[0.98] whitespace-nowrap self-start lg:self-center"
              >

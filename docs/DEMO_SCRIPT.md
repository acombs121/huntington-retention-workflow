...
- **Presenter Action**:
  ...
  5. Inspect the **Borrower Settlement Routing Packet**, which now exists:
  ...
  6. Click **[Record Client Opt-In]** to lift the GLBA Privacy Gate:
  ...
  7. Click **[Proceed to Advisor Routing]**:

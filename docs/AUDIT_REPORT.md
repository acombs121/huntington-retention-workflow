...
| :--- | :---: | :---: | :--- |
| **I. Tax, Legal & Regulatory Rules** | 6 | **5 Verified / 1 Partially Verified** | 26 CFR § 1.1031, FINRA Rule 2040, SEC Reg R, 15 U.S.C. § 6801 (GLBA), 12 U.S.C. § 1831f (EGRRCPA) |
...
### 2. Huntington Confines Itself to the Qualified Escrow Depository Role
* **Restated claim:** *"Huntington uses an independent Qualified Intermediary (QI) and does not act as QI itself."* An earlier version of this entry said the bank was **barred** from the QI role by the disqualified-person rules. That is not established, and the claim has been restated.
...
* **Legal Substance:** This is a deliberate risk posture rather than a strict legal prohibition. Three qualifications on the earlier "barred" framing: (a) the disqualified-person agency prong at § 1.1031(k)-1(k)(2) **expressly excludes** routine financial, title insurance, escrow and trust services by a financial institution at (k)(2)(ii) — the same carve-out §3 of this document relies on — so (k)(2) does not on its face bar a bank from the QI role; (b) the 12 U.S.C. § 29 rationale depends on the premise that a QI must take title, but the regulation provides ways for a QI to be *treated as* acquiring and transferring the relinquished property without taking title, which is why direct deeding is standard practice; and (c) bank-affiliated QI entities are understood to exist in the market, though none is named here because that could not be verified. Confining the bank to the escrow-depository role keeps it clearly inside the (k)(2)(ii) carve-out, avoids the national-bank real-property questions, and avoids state QI licensing regimes.
* **Verdict:** **PARTIALLY VERIFIED** — the conclusion is sound; the stated reason is not established. **Tax counsel should confirm before this is offered.** Ask one question: *"can a bank affiliate act as QI, and if not, why not?"*

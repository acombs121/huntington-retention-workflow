...
class LiquidityEngine:
    ...
    def assess(
        ...
        if is_1031:
            ...
            wire_account_title = f"{payoff.seller_entity} / Huntington 1031 Escrow"
            wire_account_number = "HBAN-QI-8819-01"
            special_instructions = (
                "DO NOT DISBURSE OUTSIDE OF HUNTINGTON ESCROW. Funds held pursuant to "
                "IRC § 1031 Qualified Escrow Agreement (Treas. Reg. § 1.1031(k)-1(g)(3))."
            )
        else:
            depository_route = StatutoryDepositoryRoute(
            ...
            wire_account_title = f"{payoff.seller_entity} / Max$aver ICS Sweep"
            wire_account_number = "HBAN-4401-9921-00"
            special_instructions = (
                "Disburse net seller equity directly into Huntington Max$aver ICS Sweep "
                "for FDIC passthrough protection."
            )
